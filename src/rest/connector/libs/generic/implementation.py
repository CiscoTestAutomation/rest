...
class Implementation(Imp):
    '''Rest Implementation for Generic Rest Connector

    This class implements the Rest Connector for a Generic Rest Connector.
    It will make a call to the provided url and check the specification to identify the device's OS.
    ...
    def connect(self, timeout=30):
        ...
        if not port:
            raise Exception("must include a port")
